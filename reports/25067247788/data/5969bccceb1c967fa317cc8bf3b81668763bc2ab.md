...
- Name: a11y.spec.js >> Settings page has no critical/serious a11y violations
    ...
    - main [ref=e181]:
      - generic [ref=e183]:
        - generic [ref=e184]:
          ...
          - heading "Settings" [level=1] [ref=e187]
          - generic [ref=e188]:
            - paragraph [ref=e189]:
        ...
        - generic [ref=e196]:
          - heading "Environment Information" [level=2] [ref=e197]
          - table [ref=e198]:
            - rowgroup [ref=e199]:
              - 'row "Running on Pantheon:  Yes" [ref=e200]':
                - rowheader "Running on Pantheon:" [ref=e201]
                - cell " Yes" [ref=e202]:
                  - generic [ref=e203]: 
                  - text: "Yes"
              - 'row "Site ID: 79f9c59d-a7b5-4961-ae8a-b1291065518e" [ref=e204]':
                - rowheader "Site ID:" [ref=e205]
                - cell "79f9c59d-a7b5-4961-ae8a-b1291065518e" [ref=e206]:
                  - code [ref=e207]: 79f9c59d-a7b5-4961-ae8a-b1291065518e
              - 'row "Environment: e2e-3" [ref=e208]':
                - rowheader "Environment:" [ref=e209]
                - cell "e2e-3" [ref=e210]:
                  - code [ref=e211]: e2e-3
              - 'row "Pantheon Secrets API:  Available" [ref=e212]':
                - rowheader "Pantheon Secrets API:" [ref=e213]
                - cell " Available" [ref=e214]:
                  - generic [ref=e215]: 
                  - text: Available
          - separator [ref=e216]
          - table [ref=e217]:
            - rowgroup [ref=e218]:
              - row "Machine Token  A site-wide machine token is currently set (shared by all admins). Migrate to My Account Starting with version 0.4.0, each admin can have their own machine token for better security and audit trails. Click \"Migrate to My Account\" to copy the site-wide token to your user account." [ref=e219]:
                - rowheader "Machine Token" [ref=e220]
                - cell " A site-wide machine token is currently set (shared by all admins). Migrate to My Account Starting with version 0.4.0, each admin can have their own machine token for better security and audit trails. Click \"Migrate to My Account\" to copy the site-wide token to your user account." [ref=e221]:
                  - paragraph [ref=e222]:
                    - generic [ref=e223]: 
                    - text: A site-wide machine token is currently set (shared by all admins).
                  - paragraph [ref=e224]:
                    - link "Migrate to My Account" [ref=e225] [cursor=pointer]:
                      - /url: https://e2e-3-cxr-ash-nazg.pantheonsite.io/wp-admin/admin.php?page=ash-nazg-settings&ash_nazg_migrate=me&_wpnonce=3d6e6d9ebf
                  - paragraph [ref=e226]: Starting with version 0.4.0, each admin can have their own machine token for better security and audit trails. Click "Migrate to My Account" to copy the site-wide token to your user account.
        - generic [ref=e227]:
          - generic [ref=e228]:
            - heading "Test Connection" [level=2] [ref=e229]
            - paragraph [ref=e230]: Test your Pantheon API connection to verify the machine token is valid.
            - paragraph [ref=e232]:
              - button "Test Connection" [ref=e233] [cursor=pointer]
          - generic [ref=e234]:
            - heading "Clear Session Token" [level=2] [ref=e235]
            - paragraph [ref=e236]: Clear the cached session token. Use this if you are experiencing authentication issues or after API downtime. A new session token will be generated automatically on the next API request.
            - paragraph [ref=e238]:
              - button "Clear Session Token" [ref=e239] [cursor=pointer]
