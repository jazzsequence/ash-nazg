...
- Name: a11y.spec.js >> Metrics page with data loaded has no a11y violations
- Location: tests/e2e/a11y.spec.js:53:1
      ...
      - generic [ref=e183]:
        ...
        - generic [ref=e197]:
          ...
          - generic [ref=e199]:
            ...
            - button "Load Metrics" [active] [ref=e206] [cursor=pointer]
